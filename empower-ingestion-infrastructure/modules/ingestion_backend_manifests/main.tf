resource "helm_release" "ingestion-backend" {
  name       = "empower-foundation-ingestion-backend"
  chart      = "${path.module}/charts/empoweringestionbackend-0.1.0.tgz"
  namespace  = var.ingestion_backend_namespace
